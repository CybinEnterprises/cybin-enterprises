...
function FieldLabel({
  ...
  required,
  completed,
}: { label: string; required?: boolean; completed?: boolean }) {
  return (
    <div
      style={{
        display: "flex",
...
function ProgressBar({
  ...
  step,
  total,
}: { pct: number; step: number; total: number }) {
  return (
    <div data-ocid="apply.progress.panel" style={{ marginBottom: 32 }}>
      ...
      >
        ...
        <span
          style={{ fontSize: "0.75rem", fontWeight: 700, color: "#00d4b8" }}
        >
          {pct}%
        </span>
      </div>
...
function StepCompletedTag({ label }: { label: string }) {
  return (
    ...
    >
      ...
      <span style={{ fontSize: "0.8rem", color: "#00d4b8", fontWeight: 600 }}>
        {label}
      </span>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          Enterprise Account Eligible
        </p>
        <p style={{ fontSize: "0.8rem", color: "rgba(201,168,76,0.8)" }}>
          Our executive team will personally review your account.
        </p>
      </div>
    </div>
  );
    ...
    <div style={{ minHeight: "100dvh", backgroundColor: "#0a0f1e" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontSize: "0.75rem", color: "rgba(0,212,184,0.8)" }}>
            Secure
          </span>
        </div>
      </header>
              ...
              {[
                {
                  ...
                  sub: "256-bit encryption. Never shared without consent.",
                },
                {
                  icon: Clock,
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: 8,
                      background:
                        "linear-gradient(135deg, rgba(0,212,184,0.15) 0%, rgba(124,92,191,0.15) 100%)",
                      border: "1px solid rgba(0,212,184,0.2)",
                      display: "flex",
                      alignItems: "center",
          ...
          <div style={{ maxWidth: 520, margin: "0 auto" }}>
            ...
            {step === 1 && (
              <div>
                ...
                >
                  This takes less than 2 minutes. No commitment.
                </p>
                ...
                <div style={{ marginBottom: 28 }}>
                  <FieldLabel
                    label="What's the primary issue?"
                    completed={issueDone}
                  />
                  <select
                    value={issue}
            ...
            {step === 2 && (
              <div>
                ...
                >
                  Help us match you to the right processors.
                </p>
            ...
            {step === 3 && (
              <div>
                ...
                >
                  A real person will review your situation.
                </p>
                ...
                >
                  ...
                  >
                    Your information is secure and reviewed only by our team. We
                    never share or sell your details.
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    Complete the full underwriting application now and our team
                    can approve you faster with everything needed upfront.
                  </p>
                  <button
                    type="button"
                    onClick={advanceToFull}
                    className="cybin-btn-blue"
                    style={{
                      width: "100%",
                      justifyContent: "center",
                  ...
                  >
                    <FileText size={16} /> Complete Full Application{" "}
                    <ArrowRight size={16} />
                  </button>
                </div>
                ...
                <div style={{ display: "flex", gap: 12 }}>
                  ...
                  >
                    {isEnterprise ? "Request Review" : "Submit Application"}{" "}
                    <ArrowRight size={16} />
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Complete for faster approval. Required fields marked with
                      •
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    After submission, you may be asked for: Driver's license,
                    business license, bank statements (3 months). We'll guide
                    you through this.
                  </p>
                </div>
                ...
                <div style={{ display: "flex", gap: 12 }}>
                  ...
                  <button
                    ...
                    style={{
                      flex: 2,
                      justifyContent: "center",
                      opacity: step4Valid && !isSubmitting ? 1 : 0.5,
                      cursor:
                        step4Valid && !isSubmitting ? "pointer" : "not-allowed",
                      background:
                        "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)",
                    }}
                  >
            ...
            {step === "reviewing" && (
              <div style={{ textAlign: "center", padding: "80px 0" }}>
                ...
                />
                <p style={{ color: "rgba(232,245,242,0.8)", fontSize: "1rem" }}>
            ...
            {step === "success" && (
              <div style={{ animation: "fadeRise 0.5s ease" }}>
                <div style={{ textAlign: "center", marginBottom: 36 }}>
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(135deg, rgba(0,212,184,0.2), rgba(124,92,191,0.2))",
                  ...
                  >
                    {isEnterprise
                      ? "Our executive team will contact you within 1 business day."
                      : "You'll hear from us within 24 hours. A real person — not automation."}
                  </p>
                </div>
                ...
                >
                  ...
                  {[
                    { time: "24 hours", desc: "Personal review by our team" },
                    { time: "1-2 days", desc: "Processor options identified" },
                    { time: "2-3 days", desc: "We walk you through options" },
                    { time: "3-10 days", desc: "We manage approval process" },
                  ].map(({ time, desc }) => (
                    <div
                      key={time}
