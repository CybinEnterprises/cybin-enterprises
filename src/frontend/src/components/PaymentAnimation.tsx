...
export default function PaymentAnimation({
  ...
  useEffect(() => {
    ...
    const drawBank = () => {
      ...
      halo.addColorStop(
        0,
        isLight ? "rgba(99, 102, 241, 0.15)" : "rgba(110, 247, 212, 0.1)",
      );
      ...
      bodyGradient.addColorStop(
        0,
        isLight ? "rgba(71, 85, 105, 0.98)" : "rgba(51, 65, 85, 0.98)",
      );
      bodyGradient.addColorStop(
        0.5,
        isLight ? "rgba(100, 116, 139, 0.98)" : "rgba(71, 85, 105, 0.98)",
      );
      bodyGradient.addColorStop(
        1,
        isLight ? "rgba(71, 85, 105, 0.98)" : "rgba(51, 65, 85, 0.98)",
      ...
      doorGradient.addColorStop(
        0,
        isLight ? "rgba(148, 163, 184, 0.98)" : "rgba(100, 116, 139, 0.98)",
      );
      doorGradient.addColorStop(
        0.7,
        isLight ? "rgba(71, 85, 105, 0.98)" : "rgba(51, 65, 85, 0.98)",
      ...
      doorGradient.addColorStop(
        1,
        isLight ? "rgba(30, 41, 59, 0.98)" : "rgba(15, 23, 42, 0.98)",
      );
      ...
      hubGradient.addColorStop(
        0,
        isLight ? "rgba(99, 102, 241, 0.9)" : "rgba(110, 247, 212, 0.9)",
      );
      hubGradient.addColorStop(
        1,
        isLight ? "rgba(79, 70, 229, 0.9)" : "rgba(52, 211, 153, 0.9)",
      );
